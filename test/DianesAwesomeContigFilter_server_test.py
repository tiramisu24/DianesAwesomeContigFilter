...
from DianesAwesomeContigFilter.DianesAwesomeContigFilterImpl import DianesAwesomeContigFilter
from DianesAwesomeContigFilter.DianesAwesomeContigFilterServer import MethodContext
from DianesAwesomeContigFilter.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class DianesAwesomeContigFilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('DianesAwesomeContigFilter'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'DianesAwesomeContigFilter',
        ...
        cls.serviceImpl = DianesAwesomeContigFilter(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_DianesAwesomeContigFilter_" + str(suffix)
